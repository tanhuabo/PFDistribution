...
public class NetworkResult {
    ...
    public NetworkResult(String type,String totalTimeStr,String totalPriceStr,List<Integer> sectionList, List<String> stationList, List<List<String>> transferList){
        this.type=type;
